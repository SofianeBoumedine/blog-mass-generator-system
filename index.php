...
function parseArticle($filepath) {
    ...
    if (preg_match('/<title>(.*?)<\/title>/i', $content, $matches)) {
        $article['title'] = str_replace(' - LemmiLink Blog', '', $matches[1]);
    }
...
<head>
    ...
    <title>Blog LemmiLink - Articles SEO, Netlinking et Backlinks</title>
    <meta name="description" content="Découvrez nos articles sur le netlinking, le SEO et les backlinks. Conseils d'experts pour améliorer votre référencement avec LemmiLink.">
    <meta name="keywords" content="blog SEO, articles netlinking, conseils backlinks, LemmiLink, référencement naturel">
    <link rel="canonical" href="https://lemmilink.com/blog">

    <!-- Favicon -->
    <link rel="icon" type="image/gif" href="assets/images/common/LemmiLink.gif">
    <link rel="shortcut icon" type="image/gif" href="assets/images/common/LemmiLink.gif">
                        ...
                        <div class="uc-navbar-left">
                            <div class="uc-logo">
                                <a class="panel text-none" href="index.html" style="margin-left: 40px;">
                                    <img src="assets/images/common/LemmiLink.gif" alt="LemmiLink" style="height: 55px; width: auto; border-radius: 25px;">
                                </a>
                            </div>
                        </div>
        ...
        <div class="blog-hero">
            <div class="container xl:max-w-xl">
                <div class="text-center text-white">
                    <h1 class="h2 lg:h1 xl:display-6">Blog LemmiLink</h1>
                    ...
                    <div class="uc-footer-inner vstack gap-4 lg:gap-6 xl:gap-8">
                                    ...
                                    <div class="panel vstack items-start gap-3 xl:gap-4 lg:max-w-1/2">
                                        <div>
                                            <a href="index.html" style="width: 140px">
                                                <img src="assets/images/common/LemmiLink.gif" alt="LemmiLink" style="height: 60px; width: auto; border-radius: 8px;">
                                            </a>
                        ...
                        <div class="uc-footer-bottom panel vstack lg:hstack gap-4 justify-between text-center pt-4 lg:pt-6 border-top dark:text-white">
                            <div class="vstack gap-2 lg:items-start">
                                <p class="opacity-60">© 2025 LemmiLink. Tous droits réservés par LemmiLink</p>
                            </div>
