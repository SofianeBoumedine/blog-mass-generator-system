...
class ThematicContentLibrary {
    ...
    initializeThemes() {
        return {
                ...
                services: [
                    {
                        ...
                        description: 'Programme d\'entraînement sur-mesure avec séances individuelles. Exercices adaptés, suivi de performance et récupération optimisée.'
                    },
                    {
                        icon: '👥',
                        name: 'Cours collectifs',
                        description: 'Séances de cardio, endurance et renforcement. HIIT, yoga, cycling : des exercices variés pour tous les niveaux.'
                    },
                    {
                        icon: '🏋️',
                        name: 'Musculation & Force',
                        description: 'Espace musculation complet. Travaillez force, souplesse et endurance avec un programme de séries et répétitions adapté.'
                    },
                    {
                        icon: '🥗',
                        name: 'Nutrition & Récupération',
                        description: 'Optimisez votre nutrition et votre récupération. Conseils personnalisés pour des performances durables.'
                    }
                ],
            ...
            // ══════════════════════════════════════════════════════════════════
            // GENERAL - Thème par défaut / Fallback
            // ══════════════════════════════════════════════════════════════════
            general: {
                identity: {
                    sector: 'Services & Solutions',
                    subSectors: ['Services', 'Conseil', 'Accompagnement', 'Expertise'],
                    audience: 'Particuliers et professionnels',
                    tone: 'Professionnel, accessible, engageant'
                },

                vocabulary: {
                    nouns: ['service', 'solution', 'accompagnement', 'expertise', 'qualité', 'client', 'projet', 'équipe', 'engagement', 'confiance', 'résultat', 'conseil', 'partenaire', 'expérience'],
                    verbs: ['accompagner', 'proposer', 'offrir', 'garantir', 'conseiller', 'réaliser', 'développer', 'améliorer', 'personnaliser'],
                    adjectives: ['professionnel', 'personnalisé', 'fiable', 'qualifié', 'réactif', 'efficace', 'transparent', 'durable', 'accessible'],
                    expressions: [
                        'à votre service',
                        'votre satisfaction',
                        'accompagnement personnalisé',
                ...
                entities: {
                    brands: [],
                    places: ['bureau', 'agence', 'siège'],
                    certifications: ['Certifié', 'Agréé', 'Reconnu'],
                    experts: [
                        { name: 'Marie Dupont', title: 'Directrice générale' },
                        { name: 'Pierre Martin', title: 'Responsable clientèle' },
                        { name: 'Sophie Bernard', title: 'Experte conseil' }
                    ]
                },
                ...
                heroContent: {
                    ...
                    subtitles: [
                        'Une équipe dédiée vous accompagne dans tous vos projets avec professionnalisme et réactivité.',
                        'Découvrez des solutions sur-mesure, pensées pour répondre à vos attentes.',
                        'Depuis plus de 10 ans, nous mettons notre expertise au service de votre réussite.'
                    ],
                    badges: ['⭐ Satisfaction garantie', '🤝 Accompagnement personnalisé', '✓ Expertise reconnue']
                },

                aboutContent: {
                    stories: [
                        'Fondée il y a plus de 10 ans, notre entreprise s\'est construite autour d\'une valeur centrale : placer le client au cœur de toutes nos actions. Notre équipe passionnée met tout en œuvre pour vous accompagner au quotidien.',
                        'Notre histoire, c\'est avant tout celle d\'une équipe passionnée par son métier. Depuis nos débuts, nous cultivons l\'excellence et la proximité pour offrir un service à la hauteur de vos attentes.'
                    ],
                    missions: [
                        'Accompagner nos clients avec professionnalisme',
                        'Proposer des solutions adaptées à chaque besoin',
                        'Garantir qualité et satisfaction à chaque étape'
                    ],
                    values: ['Qualité', 'Proximité', 'Engagement', 'Transparence', 'Excellence']
                },
                ...
                services: [
                    {
                        ...
                        description: 'Un accompagnement sur-mesure pour répondre à vos besoins spécifiques avec expertise et professionnalisme.'
                    },
                    {
                        icon: '⚡',
                        name: 'Réactivité',
                        description: 'Une équipe disponible et réactive, prête à intervenir rapidement pour vous satisfaire.'
                    },
                    {
                        icon: '🔧',
                        name: 'Solutions complètes',
                        description: 'Des prestations clé en main pour vous simplifier la vie et vous faire gagner du temps.'
                    },
                    {
                        icon: '🛡️',
                        name: 'Garantie qualité',
                        description: 'Un engagement fort sur la qualité de nos services, avec suivi et satisfaction garantie.'
                    }
                ],

                testimonials: [
                    {
                        text: 'Un service irréprochable du début à la fin. L\'équipe est à l\'écoute et vraiment professionnelle. Je recommande vivement.',
                        author: 'Marie D.',
                        role: 'Cliente satisfaite',
                        avatar: 'MD'
                    },
                    {
                        text: 'Excellente expérience ! Réactivité, qualité et prix juste. Exactement ce que je recherchais.',
                        author: 'Pierre L.',
                        role: 'Client régulier',
                        avatar: 'PL'
                    },
                    {
                        text: 'Professionnels et efficaces. Ils ont su s\'adapter à mes besoins et m\'ont accompagné avec bienveillance.',
                        author: 'Sophie M.',
                ...
                ctas: {
                    primary: ['Nous contacter', 'Demander un devis', 'En savoir plus'],
                    secondary: ['Nos services', 'À propos', 'Témoignages'],
                    newsletter: 'Restez informé de nos actualités et offres'
                },

                colors: {
                    primary: '#3B82F6',    // Bleu confiance
                    secondary: '#6366F1',  // Indigo pro
                    accent: '#F59E0B',     // Ambre accent
                    gradients: ['#3B82F6, #2563EB', '#6366F1, #4F46E5']
                },

                avoid: []  // Pas de mots à éviter pour le thème général
            }
        };
    }
